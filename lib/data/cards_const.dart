...
const cardIronIngots = CardModel(
  type: TypeCard.material,
  id: 10,
  name: 'Iron ingots',
  description:
...
const cardCopperLine = CardModel(
  type: TypeCard.material,
  id: 12,
  name: 'Copper line',
  description:
...
const cardInsulators = CardModel(
  type: TypeCard.material,
  id: 13,
  name: 'Insulators',
  description:
...
const cardSolarCells = CardModel(
  type: TypeCard.material,
  id: 14,
  name: 'Solar cells',
  description:
...
const cardHealthySalad = CardModel(
  type: TypeCard.food,
  id: 31,
  name: 'Healthy Salad',
  description:
...
const cardFruitShake = CardModel(
  type: TypeCard.food,
  id: 32,
  name: 'Fruit Shake',
  description:
...
const cardPotatoOmelet = CardModel(
  type: TypeCard.food,
  id: 33,
  name: 'Potato Omelet',
  description:
...
const cardElectronicsTable = CardModel(
  type: TypeCard.material,
  id: 41,
...
const cardSolarPanel = CardModel(
  type: TypeCard.material,
  id: 42,
  name: 'Solar panel',
  description:
...
const cardGreenhouse = CardModel(
  type: TypeCard.material,
  id: 46,
  name: 'Greenhouse',
  description:
...
const cardWindTurbine = CardModel(
  type: TypeCard.material,
  id: 47,
  name: 'Wind turbine',
  description:
...
const cardRecyclingCenter = CardModel(
  type: TypeCard.material,
  id: 48,
...
const cardCompostingMachine = CardModel(
  type: TypeCard.material,
  id: 49,
...
const cardCCBurgers = CardModel(
  type: TypeCard.food,
  id: 56,
  name: 'CC Burgers',
  description:
      '''The stomach's best friends and the diet's worst enemies. A quick fix for those busy days, even if their nutritional content is as mysterious as the cave they come from.''',
  prize: 1,
  quantity: 1,
);
const cardEmployment = CardModel(
...
const cardBananaTree = CardModel(
  type: TypeCard.plant,
  id: 60,
  name: 'Banana Tree',
  description:
